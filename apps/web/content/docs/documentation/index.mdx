...
TechShip includes a documentation site built using [Contentlayer](https://contentlayer.dev) and [MDX](http://mdxjs.com).
...
<Card href="/docs/documentation/contentlayer" disabled>
