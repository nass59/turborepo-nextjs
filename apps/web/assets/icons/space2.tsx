    ...
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        ...
        <path
          ...
          fill="#fff"
        />
        <circle cx="81.85" cy="231.66" fill="#fff" r="2.94" />
        <circle cx="130.01" cy="135.34" fill="#fff" r="2.94" />
        <path
          ...
          fill="#fff"
        />
        <circle cx="94.43" cy="169.18" fill="#fff" r="1.47" />
        <path
          d="M144.33 130.56a1.47 1.47 0 11-1.47-1.46 1.47 1.47 0 011.47 1.46z"
          fill="#fff"
        />
        <circle cx="212.02" cy="81.26" fill="#fff" r="1.47" />
        <circle cx="250.04" cy="162.24" fill="#fff" r="1.47" />
        <circle cx="61.89" cy="289.97" fill="#fff" r="1.47" />
        <circle cx="86.35" cy="311.93" fill="#fff" r="1.47" />
        <circle cx="76.64" cy="320.88" fill="#fff" r="1.47" />
        <circle cx="176.44" cy="86.74" fill="#fff" r="1.47" />
        <circle cx="202.47" cy="157.03" fill="#fff" r="1.47" />
        <circle
          cx="223.12"
          cy="146.79"
          fill="#fff"
        ...
        />
        <circle cx="71" cy="201.29" fill="#fff" r="7.12" />
        <circle cx="119.94" cy="173.43" fill="#fff" r="4.43" />
        <circle cx="287" cy="210.75" fill="#fff" r="4.43" />
        <path
      ...
      <g>
        ...
        <path
          ...
          fill="#263238"
        />
        <ellipse cx="170.88" cy="389.39" fill="#263238" rx="12.33" ry="10.96" />
        <ellipse cx="201.02" cy="385.28" fill="#263238" rx="12.33" ry="10.96" />
      </g>
    </svg>
  );
};
