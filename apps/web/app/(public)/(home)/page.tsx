    ...
    <>
      ...
      <section id="open-source" className="py-8 md:py-12 lg:py-24">
        <div className="container mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-[85%] leading-normal sm:text-lg sm:leading-7">
          ...
          <div className="flex">
            ...
            {stars && (
              <div className="flex items-center">
                <div className="h-4 w-3 border-y-8 border-r-8 border-l-0 border-solid border-y-transparent border-r-slate-800"></div>
